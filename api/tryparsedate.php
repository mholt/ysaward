...
@ $strictMonthDayYear = isset($_GET['strictMonthDayYear']);
...
{
	if (!$timestamp)
		Response::Send(400, "Date format not recognized. Try spelling it out, like: 30 June 2011, 4:32 PM");
}
